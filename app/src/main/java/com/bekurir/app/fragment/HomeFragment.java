package com.bekurir.app.fragment;
...
import com.bekurir.app.R;
import com.bekurir.app.activity.AllNewsActivity;
import com.bekurir.app.activity.IntroActivity;
import com.bekurir.app.activity.PromoActivity;
import com.bekurir.app.activity.TopupSaldoActivity;
import com.bekurir.app.activity.WalletActivity;
import com.bekurir.app.activity.WithdrawActivity;
import com.bekurir.app.constants.BaseApp;
import com.bekurir.app.item.AllServiceItem;
import com.bekurir.app.item.NewsItem;
import com.bekurir.app.item.CatMerchantItem;
import com.bekurir.app.item.CatMerchantNearItem;
import com.bekurir.app.item.ServiceItem;
import com.bekurir.app.item.MerchantItem;
import com.bekurir.app.item.MerchantNearItem;
import com.bekurir.app.item.RatingItem;
import com.bekurir.app.item.SliderItem;
...
import com.bekurir.app.models.AllServiceModel;
import com.bekurir.app.models.ServiceDataModel;
import com.bekurir.app.models.ServiceModel;
import com.bekurir.app.models.MerchantModel;
import com.bekurir.app.models.MerchantNearModel;
import com.bekurir.app.models.PayuModel;
import com.bekurir.app.models.User;
import com.bekurir.app.utils.SettingPreference;
import com.bekurir.app.utils.Utility;
import com.bekurir.app.utils.api.ServiceGenerator;
import com.bekurir.app.utils.api.service.UserService;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        orderManual = getView.findViewById(R.id.orderManual);
        ...
        orderManual.setOnClickListener(v -> {
            waManual();
        });
        ...
        if(getLocation != null) {
            ...
            new Handler().postDelayed(() -> {
                if (sp.getSetting()[16] != null && sp.getSetting()[17] != null) {
                    ...
                    getLocation = new Location("boyride");
    ...
    private void waManual() {
        String url = "https://api.whatsapp.com/send?phone=6285273171136&text=Hallo%20Admin%20Saya%20ingin%20order!";
